...
function populateDescription() {
	...
	var subOption = document.querySelector("option[value=" + str + "]");
	DescriptionArea.value = "Four week " + committee + " first consideration ballot for the following " + subOption.text + " record(s):";
	remarks.value = "Four week " + committee + " first consideration ballot for the following " + subOption.text + " record(s):";
	for(var i=0; i<window.AppliedRecords.children.length; i++) {
		DescriptionArea.value += "\n - "+window.AppliedRecords.children[i].value + " ";
		remarks.value += "\n - "+window.AppliedRecords.children[i].value + " ";
	}
}
